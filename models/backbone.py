...
class VisualBackbone(nn.Module):
    # Changed default num_classes to 2 for PTSD vs. non-PTSD
    def __init__(self, input_channels=3, num_classes=2, use_pretrained=True, 
                 state_dict_path="", mode="ir", embedding_dim=512):
        super().__init__()
        ...
        # If you want classification here, use 2 outputs
